...
export class ServerAPI {
	...
	static getServerUrl() {
		console.log("ServerAPI.getServerUrlCustom", ServerAPI.serverUrlCustom)
	...
	static async authenticate_with_email_and_password(email: string, password: string) {
		try {
			const client = ServerAPI.getClient();
			console.log("ServerAPI.authenticate_with_email_and_password", client);
			let result = await client.login(email, password);

			console.log("ServerAPI.authenticate_with_email_and_password result", result);
